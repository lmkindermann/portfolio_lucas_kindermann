...
A seção seguinte de Projetos, apresentam três aplicações recentemente desenvolvidas pelo autor. Duas delas como exercícios desenvolvidos durante o curso e uma delas um projeto de sistema eletrônico desenvolvido pelo autor. Todos os arquivos relacionados estão disponíveis no repositório GitHub do autor com link direto aos projetos, assim como uma cópia desta página desenvolvida.

A seção de Habilidades vem na sequencia, apresentando as cinco principais habilidades de cada área proposta pelo autor: Linguagens de Programação, Frameworks, Ferramentas, Competências e Soft-Skills. 
...
O rodapé da página encerra o seu desenvolvimento, informando a data que a página foi desenvolvida e o seu autor.